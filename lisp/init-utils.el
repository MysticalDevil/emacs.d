;;; init-utils.el --- Elisp helper functions and commands -*- lexical-binding -*-
;;; Commentary:
;;; Code:
...
(defun sanityinc/set-major-mode-name (name)
  "Override the major moe NAME in this buffer."
...
(defun sanityinc/string-all-matches (regex str &optional group)
  "Find all matches for `REGEX` with `STR`, returning the full match
...
(defun browse-current-file ()
  "Open the current file as a URL string using `browse-utl`."
  (interactive)
